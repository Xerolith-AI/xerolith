#!/usr/bin/env python3
"""
XEROLITH - Claude Edition
An AI that never forgets. Persistent memory + Claude API.
...
try:
    ...
    print("❌ Claude SDK not installed. Run:")
...
VAULT_DIR = Path.home() / ".xerolith_claude"
...
def main():
    ...
    chat = ClaudeChat(API_KEY, vault)

    # Welcome message
    print("\n" + "="*70)
    print("   XEROLITH - Claude Edition")
